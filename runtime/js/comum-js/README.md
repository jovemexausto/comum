...
- N-API (opcional): bindings nativos via `runtime/rust/comum-rs/napi`.

No React Native, o pacote usa a entrada `react-native` (`dist/mobile.js`) com runtime JS para app e E2E multi-node sem N-API.
