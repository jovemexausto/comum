...
Aplicativo React Native da Feira, mantido como superficie de referencia para um
projeto de app do ecossistema Comum.
...
- Node encapsula Commoner e fluxo local da Feira (offer/accept/receipt)
- Node aceita transporte plugavel (`attachTransport`)
- E2E usa relay WebSocket real + workers isolados

## Posicao no monorepo

- este app vive em `apps/feira/app/`
- a capsula correspondente vive em `apps/feira/capsules/`
- a simulacao correspondente vive em `apps/feira/sims/`
