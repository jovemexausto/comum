...
import { buildBeaconContextPayload, buildPlaceContextPayload, buildProximityContextPayload, buildVouchContextPayload, validateContextPayload, } from "../index.js";
function toHex(data) {
    return Buffer.from(data).toString("hex");
}
const nonce = new Uint8Array(16).fill(0xab);
const proximity = buildProximityContextPayload("nfc", nonce, 123);
const proximityHex = "a3" +
    "656e6f6e6365" +
    "50" +
    "ab".repeat(16) +
    "666d6574686f64" +
